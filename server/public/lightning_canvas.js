    ...
    var canvasLightning = function (c, cw, ch) {
        ...
        this.renderL = function () {
            ...
            while (i--) {
                ...
                if (!light.hasFired) {
                    this.ctx.fillStyle = 'rgba(28, 236, 14 ' + this.rand(4, 12) / 100 + ')';
                    this.ctx.fillRect(0, 0, this.cw, this.ch);
                }

                if (this.rand(0, 30) == 0) {
                    this.ctx.fillStyle = 'rgba(28, 236, 14, ' + this.rand(1, 3) / 100 + ')';
                    this.ctx.fillRect(0, 0, this.cw, this.ch);
                }
        ...
        this.clearCanvas = function () {
            ...
            this.ctx.fillStyle = 'rgba(28, 236, 14 ' + this.rand(1, 30) / 100 + ')';
            this.ctx.fillRect(0, 0, this.cw, this.ch);
